...
function showUser(obj){
    ...
    deleteBtn.onclick=()=>{
        axios.delete(`http://localhost:3000/delete-expanse/${obj._id}`)
            .then(response => {
    ...
    editBtn.onclick = async()=>{
        //delete old details
        await axios.get(`http://localhost:3000/get-expanseById/${obj._id}`)
            .then(response => {
                console.log(response.data.newExpanseDetails);      
        ...
        await axios.delete(`http://localhost:3000/delete-expanse/${obj._id}`)
            .then(response => {
                console.log(`Deleted post with ID ${obj._id}`);
            })
            .catch(error => {
        ...
        // await axios.put(`http://localhost:3000/edit-expanse/${obj._id}`, {
        //     amount: obj.amount,
